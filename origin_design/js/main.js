...
// hour chart
const hour_chart = $.getJSON('https://min-api.cryptocompare.com/data/histohour?fsym=BTC&tsym=USD&limit=2000&aggregate=3&e=CCCAGG', function (data) {
    // parse data
    var stockdata = [];
...
// day chart
const day_chart = $.getJSON('https://min-api.cryptocompare.com/data/histoday?fsym=BTC&tsym=USD&limit=2000&aggregate=3&e=CCCAGG', function (data) {
    // parse data
    var stockdata = [];
    for (var i = 0; i < data["Data"].length; i++) {
        var unitData = data["Data"][i];
